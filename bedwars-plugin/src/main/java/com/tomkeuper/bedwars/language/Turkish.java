...
public class Turkish extends Language {
    ...
    public Turkish() {
        ...
        yml.addDefault(Messages.ARENA_ANNOUNCEMENT, Arrays.asList("&c&lIf you get disconnected use /rejoin to join back in the game.", "&c&lCross-teaming is not allowed! Report cross-teamers using /report."));
