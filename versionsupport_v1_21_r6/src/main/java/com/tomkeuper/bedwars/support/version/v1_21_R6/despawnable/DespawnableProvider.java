...
package com.tomkeuper.bedwars.support.version.v1_21_R6.despawnable;
...
public abstract class DespawnableProvider<T> {
    ...
    protected PathfinderGoalSelector getGoalSelector(@NotNull EntityCreature entityLiving) {
        return entityLiving.cq;
    }

    protected void clearSelectors(@NotNull EntityCreature entityLiving) {
        entityLiving.cr.b().clear();
        entityLiving.cq.b().clear();
    }
    ...
    protected void applyDefaultSettings(org.bukkit.entity.@NotNull LivingEntity bukkitEntity, DespawnableAttributes attr,
        ...
        Objects.requireNonNull(entity.fp().a(GenericAttributes.t)).a(attr.health());
        Objects.requireNonNull(entity.fp().a(GenericAttributes.w)).a(attr.speed());
        Objects.requireNonNull(entity.fp().a(GenericAttributes.c)).a(attr.damage());
    }
}
