...
public final class v1_21_R6 extends VersionSupport {
    ...
    public String getMainLevel() {
        ...
        return ((DedicatedServer) MinecraftServer.getServer()).a().w;
    }
    ...
    public void updatePacketArmorStand(GeneratorHolder gh, Iterable<Player> players) {
        ...
        PacketPlayOutEntityMetadata metadata = new PacketPlayOutEntityMetadata(armorStand.getEntityId(), nmsEntity.aC().c());
        List<Pair<EnumItemSlot, ItemStack>> items = Collections.singletonList(Pair.of(EnumItemSlot.f, CraftItemStack.asNMSCopy(gh.getHelmet())));
    ...
    public void updatePacketArmorStandEquipment(GeneratorHolder generatorHolder) {
        ...
        EntityArmorStand nmsEntity = ((CraftArmorStand) armorStand).getHandle();
        List<Pair<EnumItemSlot, ItemStack>> items = Collections.singletonList(Pair.of(EnumItemSlot.f, CraftItemStack.asNMSCopy(generatorHolder.getHelmet())));
        PacketPlayOutEntityEquipment equipment = new PacketPlayOutEntityEquipment(armorStand.getEntityId(), items);
        PacketPlayOutEntityMetadata metadata = new PacketPlayOutEntityMetadata(armorStand.getEntityId(), nmsEntity.aC().c());
